...
void EmptyLinkFunctionForGeneratedCode1BattleTank() {}
	...
	IMPLEMENT_CLASS(ATank, 810287522);
	...
	IMPLEMENT_CLASS(UTankBarrel, 3243144034);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_MinElevation = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinElevation"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinElevation, UTankBarrel), 0x0040000000000001);
				UProperty* NewProp_MaxElevation = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxElevation"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxElevation, UTankBarrel), 0x0040000000000001);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				MetaData->SetValue(NewProp_MinElevation, TEXT("Category"), TEXT("Setup"));
				MetaData->SetValue(NewProp_MinElevation, TEXT("ModuleRelativePath"), TEXT("Public/TankBarrel.h"));
				MetaData->SetValue(NewProp_MinElevation, TEXT("ToolTip"), TEXT("Sensible default"));
				MetaData->SetValue(NewProp_MaxElevation, TEXT("Category"), TEXT("Setup"));
				MetaData->SetValue(NewProp_MaxElevation, TEXT("ModuleRelativePath"), TEXT("Public/TankBarrel.h"));
				MetaData->SetValue(NewProp_MaxElevation, TEXT("ToolTip"), TEXT("Sensible default"));
